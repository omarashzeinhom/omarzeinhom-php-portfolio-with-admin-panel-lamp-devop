                    ...
                    <tbody class="app__tbody">
                        ...
                        <?php while ($category = mysqli_fetch_assoc($categories)) : ?>
                            ...
                            <tr clas="app__tr">
                                ...
                                <td class="app__td"><a href="<?= ADMIN_URL ?>edit_category.php?id=<?= $category['id'] ?>" class="app__link-btn">Edit</a></td>
                                <td class="app__td"><a href="<?= ADMIN_URL ?>delete_category.php?id=<?= $category['id'] ?>" class="app__alert-btn-sm">Delete</a>
                                </td>
