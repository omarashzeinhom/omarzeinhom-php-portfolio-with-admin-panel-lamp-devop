...
<?php if (isset($SESSION_['add-product-success'])) : ?>
    <div class="app__alert-success">
        <p class="app__alert-success-p">
            ...
            <?php unset($_SESSION['add-product-success']); ?>
        </p>
    </div>
...
<!-- App Add User Start  -->
<form class="" action="<?= ADMIN_URL ?>add_product-logic.php" enctype="multipart/form-data" method="POST" style="width: 90vw; margin-left : 5vw;">
    <div class="row">
        <!-- Row Start   --->
        <?php
        if (isset($_SESSION['user_is_admin'])) : ?>
            <div class="col-12">
                ...
                <div class="app__inputs-wrap">
                    ...
                    <input name="name" class="app__input" type="text" id="firstName" placeholder="Enter Product Title here..." />
                </div>
                <!-- Post Text --->
                <div class="app__inputs-wrap">
