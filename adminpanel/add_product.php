...
<!-- App Add User Start  -->
<form class="" action="<?= HOME_URL ?>add_product-logic.php" enctype="multipart/form-data" method="POST" style=" width: 90vw; margin-left : 5vw;">
    <div class="row">
        <!-- Row Start   --->
        <?php
        if (isset($_SESSION['user_is_admin'])) : ?>
            <div class="col-12">
                ...
                <div class="app__inputs-wrap">
                    ...
                    <input name="title" class="app__input" type="text" id="firstName" placeholder="Enter Product Title here..." />
                </div>
                <!-- Post Text --->
                <div class="app__inputs-wrap">
