...
<section class="app__section-form" style="width:100%; max-width: 70vw; margin-left : 15vw; max-height:70vh; height:100%;">
    <div class="container">
                    ...
                    <div class="row ">
                        <div class="col-12">
                            ...
                            <div class="app__inputs-wrap">
                                ...
                                <input name="firstname" value="<?= $firstname ?>" class="app__input" type="text" id="firstName" placeholder="Enter Name here..." />
                            </div>
                            <!-- Last Name  --->

                            <div class="app__inputs-wrap">
                                <label class="app__inputs-label">Last Name</label>
                                <input name="lastname" value="<?= $lastname ?>" class="app__input" type="text" id="lastName" placeholder="Enter Last Name here..." />
                            </div>
                            <!-- User Name  --->

                            <div class="app__inputs-wrap">
                                <label class="app__inputs-label">User Name</label>
                                <input name="username" value="<?= $username ?>" type="text" class="app__input" id="userName" placeholder="Enter User Name here..." />
                            </div>
                            ...
                            <div class="app__inputs-wrap">
                                ...
                                <input name="email" value="<?= $email ?>" type="email" class="app__input" id="email" name="email" placeholder="email@global.com" />
                            </div>
                            <!-- Password --->

                            <div class="app__inputs-wrap">
                                <label class="app__inputs-label">Password</label>
                                <input name="createpassword" value="<?= $createpassword ?>" class="app__input" type="password" id="createpassword" placeholder="Enter password here..." />
                            </div>
                            <!-- Confirm Password  --->

                            <div class="app__inputs-wrap">
                                <label class="app__inputs-label">Confirm Password</label>
                                <input name="confirmpassword" value="<?= $confirmpassword ?>" class="app__input" type="password" id="confirmpassword" placeholder="Confrim password here..." />
                            </div>
                            ...
                            <select name="user__role" value="<?= $user__role ?>" class="app__input">
