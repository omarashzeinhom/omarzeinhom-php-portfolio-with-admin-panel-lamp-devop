    ...
    <aside>
        ...
        <ul class='app__sidenav-items'>
            ...
            <?php if (isset($_SESSION['user_is_admin'])) : ?>
                <!-- Abouts  Start -->
                <li class='app__sidenav-item'><a href="<?= HOME_URL ?>manage_abouts.php" class="app__sidenav-itemLink">👤Manage
                        Abouts </a>
                ...
                <li class='app__sidenav-item'><a href="<?= HOME_URL ?>manage_downloads.php" class="app__sidenav-itemLink">📥Manage
                        Downloads </a>
                    <!-- Downloads End -->
                ...
                <li class='app__sidenav-item'><a href="<?= HOME_URL ?>manage_categories.php" class="app__sidenav-itemLink">✨Manage
                    ...
                    <!-- Products  Start -->
                <li class='app__sidenav-item'><a href="<?= HOME_URL ?>manage_products.php" class="app__sidenav-itemLink">🛍️Manage
                        Products </a>
                    <!-- Products  end -->
